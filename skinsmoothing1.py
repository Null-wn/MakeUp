...
btn_SaveAs.place(x=580, y=380, anchor="center")
scale=tkinter.Scale(root,from_=1,to=5,orient=tkinter.HORIZONTAL,length=430,showvalue=1,tickinterval=1,resolution=1,command=level)
scale.place(x=85, y=380, anchor="w")
label=tkinter.Label(root,text='磨皮程度',anchor='center',font=('Arial', 10),width=10,height=1)
label.place(x=5, y=380, anchor="w")
path = tk.filedialog.askopenfilename()
src=cv2.imread(path)
dst1 = skinSmoothing1(src,2)
dst2 = skinSmoothing1(src,4)
dst3 = skinSmoothing1(src,6)
dst4 = skinSmoothing1(src,8)
dst5 = skinSmoothing1(src,10)
Showimage(src,dst1,canva1,canva2)
root.mainloop()
